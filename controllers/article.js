...
const controller = {
    ...
    save: (req, res) => {
        ...
        let validateTitle, validateBrief, validateContent, validateCategory, validateStatus, validateAuthor;
        ...
        if (validateTitle && validateBrief && validateContent && validateCategory && validateStatus) {
